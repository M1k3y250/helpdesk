...
h. Accede en: `http://localhost:5000`
...
## Mejora adicional
Se implementó un **Dashboard con estadísticas** que muestra la cantidad de tickets por estado (OPEN, IN_PROGRESS, RESOLVED).
Se refleja en la vista principal del Dashboard
